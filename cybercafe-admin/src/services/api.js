...
// ==================== M-PESA ====================
export const initiateMpesaPush = async (data) => (await api.post('/mpesa/stkpush', data)).data;
export const checkMpesaStatus = async (checkoutRequestId) => (await api.get(`/mpesa/status/${checkoutRequestId}`)).data;
