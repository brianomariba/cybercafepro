...
// Template categories
const categories = [
    { key: 'all', label: 'All Templates', icon: <AppstoreOutlined />, count: 24 },
    { key: 'resume', label: 'Resume & CV', icon: <UserOutlined />, count: 8 },
    { key: 'business', label: 'Business', icon: <FileTextOutlined />, count: 6 },
    { key: 'education', label: 'Education', icon: <FolderOutlined />, count: 5 },
    { key: 'personal', label: 'Personal', icon: <HeartOutlined />, count: 5 },
];
...
const templates = [
    {
        ...
        description: 'Clean and modern resume template perfect for job applications.',
        category: 'resume',
        type: 'Word',
    ...
    },
    {
        ...
        description: 'Comprehensive business proposal template with all essential sections.',
        category: 'business',
        type: 'Word',
        icon: <FileWordOutlined />,
        color: '#185ABD',
    ...
    },
    {
        ...
        featured: false,
        favorite: false,
        tags: ['Finance', 'Professional', 'Auto-calculate'],
        previewUrl: null,
    },
    {
        id: 4,
        title: 'Student CV',
        description: 'Perfect resume template for students and fresh graduates.',
        category: 'resume',
        type: 'Word',
        icon: <FileWordOutlined />,
        color: '#185ABD',
    ...
    },
    {
        ...
        featured: false,
        favorite: false,
        tags: ['Professional', 'Job Application'],
        previewUrl: null,
    },
    {
        id: 6,
        title: 'Project Presentation',
        description: 'Modern presentation template for project pitches and reports.',
        category: 'education',
        type: 'PowerPoint',
        ...
        featured: true,
        favorite: false,
        tags: ['Presentation', 'Visual', 'Modern'],
        previewUrl: null,
    },
    {
        id: 7,
        title: 'Personal Budget',
        description: 'Easy-to-use budget tracker for personal finance management.',
        category: 'personal',
        type: 'Excel',
        icon: <FileExcelOutlined />,
        color: '#107C10',
    ...
    },
    {
        ...
        description: 'Academic research paper template with proper formatting.',
        category: 'education',
        type: 'Word',
        icon: <FileWordOutlined />,
        color: '#185ABD',
    ...
    },
    {
        ...
        description: 'Keep your meetings organized with this structured agenda template.',
        category: 'business',
        type: 'Word',
        icon: <FileWordOutlined />,
        color: '#185ABD',
        ...
        featured: false,
        favorite: false,
        tags: ['Business', 'Organization', 'Meetings'],
        previewUrl: null,
    },
    {
        id: 10,
        title: 'Party Invitation',
        description: 'Colorful and fun invitation template for personal events.',
        category: 'personal',
        type: 'Image',
