...
const Computer = require('../backend/models/Computer');
const Session = require('../backend/models/Session');
const Log = require('../backend/models/Log');
const Transaction = require('../backend/models/Transaction');
const PageCounterReading = require('../backend/models/PageCounterReading');
    ...
    try {
        ...
        https.get(url, (res) => {
            ...
            res.on('end', () => {
                ...
                console.log('📥 CallMeBot Response Headers:', res.headers);
